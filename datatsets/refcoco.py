...
class RefCOCODataset(Dataset):
    ...
    """
    def __init__(self, split,json_path='/.do/data/',data_path="/./wjh/datase., image_transforms=None, question_transforms=None, tokenize=None,
        ...
        json_path = os.path.join(json_path,version)
        # load refs from data/dataset/refs(dataset).json
        ref_file = os.path.join(json_path, 'refs(' + split_by + ').p')
        print(ref_file)
        ...
        instances_file = os.path.join(json_path, 'instances.json')
    ...
    def get_sample_path(self, index=None, ref=None):
        ...
        img_path = os.path.join(self.data_path,coco_split, file_name)
        return img_path
    ...
    def __getitem__(self, index):
        ...
        return {'query': text,'image_name': img_path,'sample_id': index, 'answer': answer, 'index': index,
